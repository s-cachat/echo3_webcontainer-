...
public abstract class WebContainerServlet extends HttpServlet {
     ...
     *
     * @see #process(jakarta.servlet.http.HttpServletRequest,
    ...
    /**
     * traite d'éventuelles actions. Par exemple si un objet a été ajouté dans
     * la session http, peut mettre dans la queue de l'application une action
     *
     * @param request la requete http
     * @app l'application
     */
    public void processAsyncEvents(HttpServletRequest request, ApplicationInstance conn) {
