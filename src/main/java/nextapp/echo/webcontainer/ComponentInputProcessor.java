...
/**
 * <code>ClientMessage.Processor</code> which de-serializes changed properties
 * and fired events generated by the client-side component hierarchy and passes
 * them to appropriate <code>ComponentSynchronizePeer</code>s for processing.
 */
public class ComponentInputProcessor
    ...
    /**
     * Returns the event element of the event that resulted in the client-server
     * interaction.
     *
    ...
    /**
     * Returns the id of the component that fired the event that resulted in the
    ...
    /**
     * Returns the "p" element of a specific updated property of a specific
     * component
     *
    ...
    /**
     * Parses the component synchronize directive element, storing necessary
     * values in instance variables for later processing.
     *
    ...
    /**
     * @see
     * nextapp.echo.webcontainer.ClientMessage.Processor#process(nextapp.echo.app.util.Context,
     * org.w3c.dom.Element)
     */
